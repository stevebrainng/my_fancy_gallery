...
import 'package:my_fancy_gallery/src/camera_display.dart';
import 'package:my_fancy_gallery/src/images_view_page.dart';
import 'package:my_fancy_gallery/src/utilities/enum.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';

class MyFancyGallery extends StatefulWidget {
  ...
  const MyFancyGallery.normalStyle({
    ...
    super.key,
        ...
        cropImage = false;
  const MyFancyGallery.instagramStyle({
    this.displaySource = DisplaySource.gallery,
    this.multiSelection = false,
    this.galleryDisplaySettings,
    this.pickerSource = PickerSource.image,
  ...
  @override
  MyFancyGalleryState createState() => MyFancyGalleryState();
}

class MyFancyGalleryState extends State<MyFancyGallery>
